  ...
  const importCsv = async (file?: File) => {
    ...
    try {
      ...
      for (let index = 0; index < jobs.length; index += 500) {
        const batch = jobs.slice(index, index + 500);
