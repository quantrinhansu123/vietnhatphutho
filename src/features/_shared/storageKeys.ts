/** localStorage keys — leaf module (no imports) to avoid circular load issues in dev. */
...
export const STORAGE_WAREHOUSE_SLIP_SCANNING_DRAFTS_KEY = 'warehouse_slip_scanning_drafts_v1';
export const STORAGE_AUTH_KEY = 'vietnhat_auth_user_v1';
