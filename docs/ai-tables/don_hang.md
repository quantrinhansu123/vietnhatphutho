...
- **Đơn theo quy cách khách đặt**: nút `+` xanh ở cuối mỗi dòng nhân bản toàn bộ sản phẩm thành dòng ngay bên dưới. Nút lên/xuống nằm trong ô STT; nút xóa và nút nhân bản nằm ở cột thao tác cuối.
